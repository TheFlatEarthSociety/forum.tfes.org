...
function template_main()
{
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				echo '
					...
					<td class="info">
						<h2><a class="subject" href="', $board['href'], '" name="b', $board['id'], '">', $board['name'], '</a></h2>';
	...
	<div id="posting_icons" class="floatleft">';
		...
		<ul class="reset">
			...
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_redirect.png" alt="Redirect Board" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
