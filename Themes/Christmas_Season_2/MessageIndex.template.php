...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
<td width="100%" height="29" style="background-image: url(' . $settings['images_url'] . '/top_bg.gif);background-repeat: repeat-x;" valign="middle"></td>
  </tr>
</table>
	</div>';
	}
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr class="windowbg2">
					...
					<td class="windowbg2" class="', $color_class, '" valign="middle" ', (!empty($topic['quick_mod']['modify']) ? 'id="topic_' . $topic['first_post']['id'] . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\', \'' . $context['session_id'] . '\', \'' . $context['session_var'] . '\');"' : ''), '>
	...
	// Finish off the form - again, if Quick Moderation is being done with checkboxes. (1)
		...
		<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder" style="margin-top: 1ex;">
			<tr>
				<td class="catbg2" width="100%" height="30">
					<table cellpadding="3" cellspacing="0" width="100%">
						<tr>
	...
	if (!$context['no_topic_listing'])
		echo '
				<td class="titlebg" style="padding-top: 1ex;">', !empty($modSettings['enableParticipation']) ? '
				...
				<td class="titlebg" valign="top" style="padding-top: 1ex;">
	...
	echo '
				<td class="titlebg" align="', !$context['right_to_left'] ? 'right' : 'left', '" valign="middle" id="message_index_jump_to">&nbsp;</td>
			</tr>
		</table>
