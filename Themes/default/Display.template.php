...
function template_main()
{
	...
	$normal_buttons = array(
		...
		'unsubscribe' => array('test' => 'is_subscribed', 'text' => 'unsubscribe', 'image' => 'topic_unsubscribe.gif', 'lang' => true, 'url' => $scripturl . '?action=unsubscribe;topic=' . $context['current_topic'] . ';unsubscribe=1;return=' . $context['start']),
		'subscribe' => array('test' => 'is_unsubscribed', 'text' => 'subscribe', 'image' => 'topic_subscribe.gif', 'lang' => true, 'url' => $scripturl . '?action=unsubscribe;topic=' . $context['current_topic'] . ';unsubscribe=0;return=' . $context['start']),
	...
	echo '
			<div id="forumposts">
				<div class="cat_bar">
					<h3 class="catbg">
						<img src="', $settings['images_url'], '/topic/', $context['class'], '.gif" align="bottom" alt="'.$txt[$context['class']].'" />
							...
							<div class="flow_hidden">
								<div class="keyinfo">
									<div class="messageicon">
										<img src="', $message['icon_url'] . '" alt="Message"', $message['can_modify'] ? ' id="msg_icon_' . $message['id'] . '"' : '', ' />
									</div>
									<h5 id="subject_', $message['id'], '">
										<a href="', $message['href'], '" rel="nofollow">', $message['subject'], '</a>
									</h5>
									<div class="smalltext">&#171; <strong>', !empty($message['counter']) ? $txt['reply_noun'] . ' #' . ($context['user']['id'] == 10393 ? 69 : $message['counter']) : '', ' ', $txt['on'], ':</strong> ', '<time datetime="', date('c', ($message['timestamp']-$user_info['time_offset']*3600)), '">', $message['time'], '</time> &#187;</div>
