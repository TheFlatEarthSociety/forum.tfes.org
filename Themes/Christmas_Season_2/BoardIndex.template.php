...
<table width="100%" cellpadding="3" cellspacing="0">
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr><td class="top_ls"></td>
			<td class="top" width="99%"><img id="newsupshrink" src="', $settings['images_url'], '/collapse.gif" alt="*" title="', $txt['upshrink_description'], '" align="bottom" style="margin: 0 1ex; display: none;" />', $txt['news'], '</td>
   <td class="top_rs"></td>
		</tr></table>';
		echo'
<div class="tborder" style="margin-bottom: 2ex;">
		...
		<tr>
			<td valign="middle" align="center" style="height: 60px; width:100%;" id="smfNewsFaderContainer">';

		// Prepare all the javascript settings.
		echo '
				<div class="bordercolor" id="smfNewsFader">
  ...
  <tr>
<td class="top_ls1">&nbsp;</td>
<td class="top1" width="100%" colspan="3"></td>
<td class="top_rs1">&nbsp;</td>
</tr></table>';
		echo '
<div class="tborder"><table border="0" width="100%" cellspacing="1" cellpadding="0">
	<tr class="catbg', $category['new'] ? '2' : '', '">
		...
		if (!$category['is_collapsed'])
		{
			...
			foreach ($category['boards'] as $board)
			{
				echo '
	<tr class="windowbg2">
		<td class="windowbg" width="42" height="42" align="center" valign="top"><a href="', ($board['is_redirect'] || $context['user']['is_guest'] ? $board['href'] : $scripturl . '?action=unread;board=' . $board['id'] . '.0;children'), '">';
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
<td class="btm_ls1">&nbsp;</td>
<td class="btm1" width="100%"></td>
<td class="btm_rs1">&nbsp;</td>
		</tr>
<td class="lights" colspan="3" width="100%" height="33" align="center" valign="top">&nbsp;</td>
</tr></table>';
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
<td class="top_ls">&nbsp;</td>
<td class="top" width="100%" colspan="3"></td>
<td class="top_rs">&nbsp;</td>
  </tr>
</table>';

		echo '
<table class="windowbg" border="0" width="100%" cellspacing="3" cellpadding="0">
	<tr class="markread">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
<td class="btm_ls">&nbsp;</td>
<td class="btm" width="100%"></td>
<td class="btm_rs">&nbsp;</td>
		</tr>
<td class="lights" colspan="3" width="100%" align="center" valign="top">&nbsp;<img src="', $settings['images_url'], '/blank.gif" height="33" alt="" /></td>
</tr></table></td>
	</tr>
</table>';
		}
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
		<td id="boardarea" style="padding: 1ex 10px 2ex 10px;">';
...
<div class="windowbg6"><table border="0" width="100%" cellspacing="0" cellpadding="2">
	<tr class="top">
		<td align="center" colspan="2" style="font-family: Georgia, sans-serif; font-size: 8pt;font-weight:bold;">', sprintf($txt['info_center_title'], $context['forum_name']), '</td>
	</tr>';
	...
	<tr>
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
				echo '
				<tr>
					<td align="left" valign="top" nowrap="nowrap">[', $post['board']['link'], '] ', $post['link'], ' ', $txt['by'], ' ', $post['poster']['link'], '</td>
	...
	if ($context['show_calendar'])
	{
		echo '
	<tr>
		<td class="titlebg6" colspan="2" height="24">&nbsp;<b>', $context['calendar_only_today'] ? $txt['calendar_today'] : $txt['calendar_upcoming'], '</b></td>
	</tr><tr>
		<td class="windowbg" width="20" valign="middle" align="center">
	...
	if ($settings['show_stats_index'])
	{
		echo '
	<tr>
		<td class="catbg2" colspan="2">&nbsp;', $txt['forum_stats'], '</td>
	</tr>
	<tr>
		<td class="windowbg" width="20" valign="middle" align="center">
	...
	echo '
				<tr>
					<td class="titlebg6" colspan="2" height="24">&nbsp;<b>', $txt['online_users'], '</b></td>
				</tr><tr>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
<td class="btm_ls2">&nbsp;</td>
<td class="btm2" width="100%" colspan="3"></td>
<td class="btm_rs2">&nbsp;</td>
		</tr></table>';
