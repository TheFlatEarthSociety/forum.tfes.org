		...
		*/
		...
		$codes = array(
			...
			array(
				...
				'validate' => isset($disabled['php']) ? null : function() use(&$tag, &$data, $disabled) {
			...
			array(
				...
				'after' => '</span>',
				'validate' => $context['browser']['is_ie'] ? function() use(&$tag, &$data, $disabled) {
					if ($data[1] == 'left')
						$data[1] = 270;
					elseif ($data[1] == 'right')
						$data[1] = 90;
					...
					elseif ($data[1] == 'bottom')
						...
						$data[1] = (int) $data[1];} : function() use(&$tag, &$data, $disabled) {
...
\'));
		...
		$codes[] = array(
				'tag' => 'spoiler',
				'before' => '<span style="background: black; color: black" onclick="(function(obj){ (obj.style.background.indexOf(\'black\') != -1) ? obj.style.background = \'\' : obj.style.background = \'black\'; })(this)">',
				'after' => '</span>'
		);
		...
		$codes[] = array(
				...
				'before' => '<span style="background: {color}; color: {color}" onclick="(function(obj){ (obj.style.background.indexOf(\'{color}\') != -1) ? obj.style.background = \'\' : obj.style.background = \'{color}\'; })(this)">',
				'after' => '</span>'
		);
