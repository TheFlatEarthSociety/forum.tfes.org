...
function template_main()
{
	...
	foreach ($context['members'] as $member)
	{
		...
		{
			echo '
								<span class="contact_info floatright">'.((strpos($member['query']['USER_AGENT'], 'Tapatalk') !== false || strpos($member['query']['USER_AGENT'], 'BYO') !== false )? '<a title="'.(strpos($member['query']['USER_AGENT'], 'BYO') !== false ? $txt['on_byo'] : $txt['on_tapatalk']).'" href="' . (isset($modSettings['tp_ol_icon_link']) && strpos($member['query']['USER_AGENT'], 'BYO') !== false ? $modSettings['tp_ol_icon_link'] : 'http://tapatalk.com') . '">
